# outlaw_rails 2.2 is optimized for use with rails 2.2.
...
unless rails_v_f >= 2.0 and rails_v_f < 2.3
  raise LoadError, "Outlaw Rails 2.2 plugin is not compatible with Rails version #{rails_v_s}.#{
    if    rails_v_f >  2.2 then " You'll need a newer Outlaw plugin, or older Rails."
    elsif rails_v_f <  2.2 then " You'll need an older Outlaw plugin, or newer Rails."
